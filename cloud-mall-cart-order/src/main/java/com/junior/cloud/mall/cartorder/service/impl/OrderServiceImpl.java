...
import com.junior.cloud.mall.cartorder.model.dao.OrderItemMapper;
import com.junior.cloud.mall.cartorder.model.dao.OrderMapper;
import com.junior.cloud.mall.cartorder.model.pojo.Order;
import com.junior.cloud.mall.cartorder.model.pojo.OrderItem;
...
import com.junior.cloud.mall.cartorder.model.vo.OrderItemVO;
...
import com.junior.cloud.mall.cartorder.utils.OrderCodeFactory;
...
//    @Transactional(rollbackFor = Exception.class)
    ...
    public String create(CreateOrderReq createOrderReq) throws ProductException {
        ...
        for (int i = 0; i < cartVOList.size(); i++) {
            ...
            productFeignClient.updateForFeign(cartVO.getProductId(),stock);
    ...
    public String qrCode(String orderNo) {
        //书写支付url
        String payUrl = "http://" + ip + "/cart-order/order/pay?orderNo=" + orderNo;
        //生成二维码图片
        try {
            QRCodeGenerator.generateQRCodeImage(payUrl, 350, 350, OrderConstant.FILE_UPLOAD_DIR + orderNo + ".png");
        ...
        //资源映射的地址
        String pngAddress = "http://" + ip + "/cart-order/images/" + orderNo + ".png";
        return pngAddress;
    }
    ...
    public void finish(String orderNo) throws ProductException {
        User user = userFeignClient.getUserForFeign();
        //订单检查
        Order order = orderMapper.selectByOrderNo(orderNo);
        if (order == null) {
            throw new ProductException(MallExceptionEnum.NO_ORDER);
